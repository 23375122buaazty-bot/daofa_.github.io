...
window.onload = function() {
  ...
  const cozeClient = new CozeWebSDK.WebChatClient({
    ...
    auth: {
      type: 'token',
      token: 'pat_H4IeIYsBTKaxACK2mei1cGO3NGBwuqVGJdMixi1Wj2M5KXg3ZrLTSlh3HY0aNFw8', // 你的PAT令牌
      onRefreshToken: async () => 'pat_H4IeIYsBTKaxACK2mei1cGO3NGBwuqVGJdMixi1Wj2M5KXg3ZrLTSlh3HY0aNFw8' // 和token一致
    },
    userInfo: {
